...
<html lang="en">
  <head>
    ...
    <!-- End layout styles -->
    <link href= "<?= base_url('assets/') ?> ../../assets/images/favicon.ico" rel="shortcut icon">
  </head>
  <body>
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                <div class="nav-profile-img">
                  <img src=" <?= base_url('assets/assets/img/profile/') . $user['gambar']?> " alt="image">
              ...
              <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                ...
                <a class="dropdown-item" href="#">
                  <i class="mdi mdi-logout me-2 text-primary" href="<?= base_url('index.php/Auth/logout');?>"></i> Signout </a>
              </div>
            </li>
            ...
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                <div class="nav-profile-image">
                  <img src=" <?= base_url('assets/assets/img/profile/') . $user['gambar']?>" alt="profile">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="general-pages">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="<?= site_url('perpustakaan/')?>"> Perpustakaan </a></li>
                </ul>
              </div>
            </li>
